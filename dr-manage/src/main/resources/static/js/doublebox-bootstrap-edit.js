(function ($, window, document, undefined) {
    ...
    BootstrapDualListbox.prototype = {
        init: function () {
            ...
            if (value) {
                this.elements.select1.attr("name", this.originalSelectName + value + "3");
                this.elements.select2.attr("name", this.originalSelectName + value + "4")
            } else {
...
(function (root, factory) {
    ...
    $.fn.doubleboxEdit = function (options) {
        ...
        box.getSelectedOptions = function () {
            var items = $("#bootstrap-duallistbox-selected-list_doubleboxEdit>option").map(function () {
                return $(this).val()
            }).get().join(",");
            return items
        };
