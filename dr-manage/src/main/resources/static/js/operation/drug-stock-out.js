var app1 = new Vue({
    ...
    methods: {
        ...
        searchItem: function (pageNo) {
            ...
            var drugStoreId = $("#searchItemId1").val();
            var type = this.searchData.searchType;
            var payType = this.searchData.searchPayType;
        ...
        downLoadExcel: function () {
            ...
            var startTime = $('#yy_search_startTime').val();
            var endTime = $('#yy_search_endTime').val();
            window.location.href = baseURL + "/DrugStockOut/export?outNo="+ outNo +"&drugStoreId="+ drugStoreId +"&type="
                + type +"&payType="+ payType +"&startTime="+ startTime +"&endTime=" + endTime
        },
        //分页
