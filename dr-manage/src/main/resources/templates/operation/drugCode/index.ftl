...
<@layout.layout title = "手工对码"; section>
    ...
    <#if section = "content">
        <#--菜单-->
        <input type="hidden" id="g_menuId" value="27">
        <#--药店-->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="white-box" style="padding-top: 4px;">
                        <h3 class="box-title">未对码的药品
                            <a href="javascript:void(0) " class="tooltip-danger"
                               data-toggle="tooltip" data-placement="top" title=""
                               data-original-title="* 所属药店为必选项" style="color: #f75b36; font-size: 14px;">
                        ...
                        <div class="m-b-10">
                            ...
                            <input type="text" id="dropSearch2"  class="form-control input-sm inline-block dropSearch wid-120 m-r-10"
                                   placeholder="请输入关键字" autocomplete="off" style="width: 140px">
                            <span class="m-r-5">商品名 : </span>
                            <input type="text" v-model="searchData.searchGoodName" class="form-control input-sm inline-block wid-140"
                    ...
                    <div class="white-box" style="padding-top: 4px;">
                        ...
                        <div class="m-b-10">
                            ...
                            <input v-model.trim="searchData2.searchKeyword" @keyup.enter="searchPlatformDrugName(1,1)"
                                   ...
                                   placeholder="请输入" autocomplete="off" style="width: 100px">
                            <span class="m-l-10">
                                <span class="m-r-5">厂家:
                                    <a href="javascript:void(0) " class="tooltip-danger" data-toggle="tooltip" data-placement="top"
                                       title="" data-original-title="输入关键字然后选择" style="color: #f75b36; font-size: 14px;">
                                ...
                                <input type="text" id="dropSearch1"  class="form-control input-sm inline-block dropSearch"
                                        placeholder="请输入关键字" autocomplete="off" style="width: 170px">
                        ...
                        <!--开始对码-->
                        <@security.authorize access="hasRole('COMPAREDRUGCODE:pairDrugCode')">
    ...
    <#if section = "js">
        ...
        <script>
            ...
            function addressParameter() {
                //药店id
                var itemStoreId = GetQueryString("itemId");
                if(itemStoreId){
                    $("#searchItemId2").val(itemStoreId)
                }else{
                    $("#searchItemId2").val("")
                }
            }
